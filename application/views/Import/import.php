        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="<?php echo base_url("Welcome/admin"); ?>" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    <a href="<?php echo base_url('import');?>" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Import</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
