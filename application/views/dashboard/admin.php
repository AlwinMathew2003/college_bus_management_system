...
<head>
    <meta charset="utf-8">
    <title>Jyothi Bus Management System</title>
...
when you are loading from outside a folder you do not have to load the file that you
are including but when you are working inside a folder it will show not found erro so you
have to load it inside the main file on which you want to include,

<?//php include 'templates/navbar.php'; ?>  without loading
<?//php $this->load->view('templates/navbar'); ?> using loading
        ...
        <!-- Recent Sales Start -->
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Active Bus Details</h6>
                        <a href="">Show All</a>
                    </div>
