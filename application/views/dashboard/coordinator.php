        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="<?php echo base_url('welcome/coordinator')?>" class="nav-item nav-link  active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    <a href="<?php echo base_url('welcome/c_attendace')?>" class="nav-item nav-link"><i class="fa fa-laptop me-2"></i>Attendance</a>
                </div>
                    ...
                    <div class="col-sm-12 col-md-6 col-xl-4">
                        <div class="h-100 bg-light rounded p-4">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <h6 class="mb-0">STUDENT REQUESTS</h6>
                            </div>
                            <div class="scroll-container" style="max-height: 300px; overflow-y: auto; padding-right: 10px;">
    <?php foreach ($pending_requests as $request): ?>
        <div class="d-flex align-items-center border-bottom py-3">
            <div class="w-100 ms-3">
                ...
                <input class="form-check-input" type="checkbox" data-user-id="<?= $request['id']; ?>">
            </div>
        </div>
    <?php endforeach; ?>
</div>
                ...
                <!-- <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Fees Receipt verification</h6>
                    </div>
...
<script>
    $(document).ready(function() {
        $('input[type="checkbox"]').on('change', function() {
            ...
            // console.log('Checkbox with user ID ' + userId + ' was checked.');
            updateStatus(userId);
        });
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo base_url('welcome/updateStatus'); ?>',
        data: { userId: userId },
