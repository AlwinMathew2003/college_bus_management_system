      ...
      <div class="col-lg-6">
          <div class="box-item">
              ...
              <form method="post" action="welcome_message.php">
                      ...
                      <input type="text" name="name" id="name" value="<?php echo $profile_data['name'];?>" readonly><br><br>
                      <label for="admission_number">Admission Number:</label>
                      <input type="text" name="admission_number" id="admission_number" value="<?php echo $profile_data['admno'];?>" readonly><br><br>
                      <label for="branch">Branch</label>
                      <input type="branch" name="branch" id="branch" value="<?php echo $profile_data['branch'];?>" readonly><br><br>
                      <label for="sem">Semester</label>
                      <input type="text" name="sem" id="sem" value="<?php echo $profile_data['sem'];?>" readonly><br><br>
                  </form>
              </div>
          </div>
      </div>
      ...
      <div class="col-lg-6">
          <div class="box-item">
              ...
              <form method="POST" action="welcome_message.php">
                      ...
                      <input type="text" id="bus_no" name="bus_no" value="<?php echo $profile_data['bus_id'];?>" readonly><br><br>
                      <label for="bus_stop">Bus Stop:</label>
                      <input type="text" id="bus_stop" name="bus_stop" value="<?php echo $profile_data['stop'];?>" readonly><br><br>
                      <label for="coordinator_name" >Coordinator Name:</label>
                      <input type="text" id="coordinator_name" name="coordinator_name" value="<?php echo $coordinator_data['name']; ?>" readonly><br><br>
                      <label for="coordinator_phone"> Coordinator Phone</label>
                      <input type="text" id="coordinator_phone" name="coordinator_phone" value="<?php echo $coordinator_data['phone_number']; ?>" readonly><br><br>
                  </form>
              </div>
          </div>
      </div>
